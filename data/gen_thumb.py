...
# AWS S3
print(os.getenv("AWS_ID"))
print(os.getenv("AWS_REG"))
...
def get_sticker(hash):
    conn = get_db_connection()
    # Create a cursor object
    cursor = conn.cursor()

    # Execute the SQL query
    cursor.execute("select sticker_url, sticker_hash from stickers where sticker_hash = %s", (hash,))
